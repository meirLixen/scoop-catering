                  ...
                  <div className="col-md-10 col-sm-12 col-xs-12  row d-flex justify-content-between">
                    ...
                    <div className=" col-md-5 col-sm-12 d-flex justify-content-center  flex-column align-items-end px-4">
                      ...
                      <p className="mt-2  text-end" style={{ color: "white" }}>
                        ...
                        מונפרר סוברט לורם שבצק יהול, לכנוץ בעריר גק ליץ, ושבעגט.
                        קוואזי במר מודוף. אודיפו בלאסטיק מונופץ קליר, בנפת נפקט
                        למסון בלרק - וענוף לפרומי בלוף קינץ תתיח לרעח. לת צשחמי
                        צש בליא, מנסוטו צמלח לביקו ננבי, צמוקו
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    {isTablet && (
                      <>
                        ...
                        <div className=" px-4 col-md-5 col-sm-12 d-flex justify-content-center  flex-column align-items-end ">
                          ...
                          >
                            לורם איפסום דולור סיט אמט, קונסקטורר אדיפיסינג אלית
                            להאמית קרהשק סכעיט דז מא, מנכם למטכין נשואי
                            מנורךגולר מונפרר סוברט לורם שבצק יהול, לכנוץ בעריר
                            גק ליץ, ושבעגט. קוואזי במר מודוף. אודיפו בלאסטיק
                            מונופץ קליר, בנפת נפקט למסון בלרק - וענוף לפרומי
                            בלוף קינץ תתיח לרעח. לת צשחמי צש בליא, מנסוטו צמלח
                            לביקו ננבי, צמוקו
                          </p>
                        </div>
                      </>
                  ...
                  <div className="col-md-10 col-sm-12 px-4 row d-flex justify-content-between my-5 blogSection">
                    ...
                    <div className="col-md-4 mt-3" style={{ height: "450px" }}>
                      ...
                      >
                        ...
                        >
                          {" "}
                          איזה פרחים כדאי לבחור לאירוע ?ואיך נדע איזה סגנון
                          מתאים{" "}
                        </p>
