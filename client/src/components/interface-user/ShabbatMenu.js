                                                    ...
                                                    <div className="col-4 p-0 mx-1" id={product._id}>
                                                        <div className="h-75 " style={{ lineHeight: "0.99" }}>
                                                            ...
                                                            <div class="amountOption pl-0 " id={product._id}>
                                                                <select class="btn-pointer amountOption_select pl-0 form-select form-select-x-sm swithDir pb-0 pt-0 border-0 rounded-custom  font-weight-bold" aria-label=".form-select-sm example" style={{ lineHeight: '1', fontSize: '16px', width: 'fit-content', fontWeight: '600 !important' }}>
                ...
                {!isMobile && !isTablet && (
                    <StickyBox offsetTop={100} offsetBottom={10}>
                        <div className=' mx-4   px-0' >
                            <div className=' h-100' >
                                <div >
                                    <select class="btn-pointer incrementFont customP text-center w-100  mb-3 form-select rounded-0 border-0 border-dark form-select-x-sm ltr m-auto   font-weight-bold border-bottom amountOption_select" aria-label=".form-select-sm example" style={{
                                        lineHeight: '1',
                                ...
                                <div class="mb-3 d-flex row justify-content-center" style={{ fontSize: '15px' }}>
                                    ...
                                    <div className='col-1 p-0 btn-pointer' onClick={() => searchProduct($('.inputOf_Search').val())}>
                                        <img style={{ width: '15px' }} src={searchIcom_} />
                                    </div>
                        ...
                        <div className='overflow-auto pb-3 sidColumn ' id='xxl' >
                            ...
                            <div className='searchResults d-none mt-1' >
                                ...
                                {serchResults && serchResults.map((product) =>
                                    <>
                                        <div className=' productLine w-100  row    justify-content-around   p-2 mb-4' id={product._id} style={{ maxHeight: '150px', height: '118px' }}>
                                            ...
                                            <div className='col-4 p-0 ' id={product._id}>
                                                <div className="h-75 " style={{ lineHeight: "0.99" }}>
                                                    <div className='productName font-weight-bold ' style={{ fontSize: '21px' }}>  {language == "he" ? product.hebrewName : product.name}</div>


                                                    <div class="amountOption pl-0 " id={product._id}>
                                                        <select class="btn-pointer amountOption_select pl-0 form-select form-select-x-sm swithDir pb-0 pt-0 border-0 rounded-custom  font-weight-bold" aria-label=".form-select-sm example"
                                                            style={{ fontSize: '16px', width: 'fit-content', fontWeight: '600 !important', lineHeight: "1" }}>
                                                            <option value=" ">{i18.t('selectAmount')}</option>
                                            ...
                                            <div className='col-4 px-1 h-100'>
                                                <div className='d-flex col-12 mx-0 px-0 align-items-end row justify-content-end h-50 mt-1'>
                                                    <div className='col-5'></div>
                                                    <div className='price productPrice text-center font-weight-bold  goldColor p-0 mr-0 col-7 fontNumber mb-2' >14.90 &#8362; </div>
                                                ...
                                                <div className='d-flex align-items-end  row justify-content-end  h-50 pb-1 flex-nowrap' >
                                                    ...
                                                    <div className='amountToBuy mx-2 goldColor d-flex  col-6 p-0  align-items-end' style={{ width: 'fit-content' }}>
                                                    ...
                                                    <div onClick={() => AddToCart(product)} className='addToCart col-5  bg-black text-white align-items-center d-flex h6  mb-0 px-4 mx-1 py-2 roundButton' style={{ height: 'fit-content', width: 'fit-content' }}>{i18.t('addToCart')}
                                                        <div className=''></div>
                                        ...
                                        <div id={category.name} onMouseEnter={() => hoverCategory(category._id, index)}>
                                            <div >
                                                ...
                                                <div className='d-flex align-items-center my-3 ' >
                                                    <h1 className='font-weight-bold mb-0'>{language == "he" ? category.hebrewName : category.name}</h1>
                                            ...
                                            {Object.keys(category).filter(key => key == "products").map((key, val) => (
                                                category[key].map(product =>
                                                    <>
                                                        <div className=' productLine w-100  row      justify-content-around   p-2 mb-4' id={product._id} style={{ maxHeight: '150px', height: '118px' }}>
                                                            <div className='col-2  productPic addM d-flex align-items-center   ' style={{ width: '140px' }}>
                                                                <div className=' ml-auto bg-gold d-flex     justify-content-center align-items-center' style={{ width: '60%', height: '20px', position: 'absolute', top: 0, right: '1px' }}><p className='m-0 ' style={{ fontSize: '0.6rem' }}>מומלץ השבוע!</p></div>
                                                                <img className=' w-100' src={image1} /></div>
                                                            <div className='col-4 p-0 ' id={product._id}>
                                                                <div className="h-75 " style={{ lineHeight: "0.99" }}>
                                                                    ...
                                                                    <div class="amountOption  pl-0 " id={product._id}>
                                                                        <select class="btn-pointer amountOption_select
                                                                        pl-0  form-select form-select-x-sm swithDir pb-0 pt-0 border-0 rounded-custom  font-weight-bold" aria-label=".form-select-sm example" style={{ lineHeight: "1", fontSize: '16px', width: 'fit-content', fontWeight: '600 !important' }}>
                                                                            <option value=" ">{i18.t('selectAmount')}</option>
                        ...
                        <div className=' px-0 mx-2' >
                            ...
                            <div className='  px-1 sidColumn col-12'>
                                ...
                                <div className=' mt-1 mb-3 actionSection col-12 p-0'  >
                                    ...
                                    <div className='py-2 col-12 text-center font-weight-bold_ incrementFont'>{i18.t('hello')},
                                        {currentUser ?
                                    ...
                                    <div className="ShoppingCart_itemList  px-2 " >
                                        <div className='d-flex w-100     justify-content-center '> {numItems == 0 ?
                                            ...
                                            <h6 className='addToCartMe py-2 px-3   my-5' style={{ color: 'gray' }}>{i18.t('addToCartMe')}

                                                <img style={{ width: '15px' }} src={'https://scoopcatering.co.il/images/cart.png'} />
                                        ...
                                        {cart && cart.map(item =>
                                            <div className={`productItem d-flex py-2 ${side} ${item.product._id}`}  >
                                                <div className='col-10 px-1'>
                                                    <div className={`productName px-1 font-weight-bold ${align}`}> {language == "he" ? item.product.hebrewName : item.product.name}</div>
                                                    <div className=' d-flex  align-items-end justify-content-between'>
                                                        <div className='  p-0 amountToBuy  goldColor d-flex  p-0  align-items-end' style={{ width: 'fit-content' }}>
                                                            <span class=" px-1 btn-pointer" onClick={() => changeAmount(item.product._id, "plusToCart")} style={{ fontSize: '25px', height: '27px' }}>+</span>
                                                            <input type="text" value={item.Amount} className=' text-black bg-white pt-0 pb-0    small_input_number fontNumber gold-border' />
                                                            <span class=" px-1 btn-pointer" onClick={() => changeAmount(item.product._id, "minusToCart")} style={{ fontSize: '25px', height: '27px' }}>-</span>
                                                        </div>
                                                ...
                                                <div className='col-2 d-flex align-items-center justify-content-end'>
                                                    <div className="col-4 d-flex align-items-end btn-pointer" onClick={() => deleteItem(item.product._id)}> <img style={{ width: '17px' }} src={deleteIcom} /></div>
                                ...
                                <div className=' col-12 rounded-custom-small customShadow px-3 pb-3 mb-3 pt-2' style={{ backgroundColor: 'rgb(195, 153, 87, 0.16)' }}>
                                            ...
                                            <div className='col-8 px-2' >
                                                ...
                                                <div className='d-flex row justify-content-between  align-items-center'>
                                                    <div className='amountToBuy col-6 goldColor d-flex    align-items-center' style={{ width: 'fit-content' }}>
                                                        <span className="mt-2 btn-pointer" onClick={() => changeAmount("plus")} style={{ fontSize: '25px', height: '44px' }}>+</span>
                                                        <input type="text" value="1" className='AmountInput p-0 text-black bg-white    m-1 my-0 small_input_number fontNumber gold-border' />
                                                        <span className="mt-2 btn-pointer" onClick={() => changeAmount("minus")} style={{ fontSize: '25px', height: '44px' }}>-</span>
                                                    </div>
                                ...
                                <button className=" d-block col-12 actionSection rounded-custom-small
                                 customShadow text-white bg-gold px-3 py-1 ml-0 w-100 border-0" onClick={() => props.history.push('/Checkout')} >{i18.t('continueToPayment')}  {language == "he" ? <i class='fas fa-solid fa-arrow-left mr-2' style={{ fontSize: '17px' }}></i> : <i class='fas fa-solid fa-arrow-right ml-2' style={{ fontSize: '17px' }}></i>} </button>
