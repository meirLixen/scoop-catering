...
export function Checkout(props) {
    ...
    const EditUserDetails = () => {
        ...
        setTimeout(() => {
            console.log("true", userDetails.lastName)
            //document.getElementById('EmailInput').value = userDetails.email
            $('#FirstNameInput').val(userDetails.firstName + " " + userDetails.lastName)
    ...
    return (
        <div onScroll={() => alert('bgvf')}>
            ...
            <div className="page_content  pt-5 offset-md-2 col-md-9  offset-sm-0 col-sm-12 " >
                <h1 className="mb-5 font-weight-bold swithSide goldColor">{i18.t('checkout')} </h1>
                    ...
                    <div className="swithSide  mb-5 overflow-checkout col-md-8 col-sm-12" >
                        <div className=" bg-grey mb-5 p-3">
                            <div className="justify-content-between" style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <div>
                                    <label className="  w-100 pt-1 swithSide  goldbgColor  mb-0" >{i18.t('PersonalInformation')} </label>
                                    <hr className="hrCheckout mt-0 mb-4" />
                                </div>
                                {userDetails.email!=undefined &&
                                <div className="d-flex align-items-center " style={{ cursor: 'pointer' }}>
                                    <img className='mx-1' style={{ width: '15px', maxHeight: '15px' }} src={editIcon} />
                                    <h6 className="mb-0" onClick={EditUserDetails}>{i18.t('EditDetails')}</h6>
                                </div>
                                }
                            ...
                            {showEditDetails &&
                                <Form className=" " onLoad={loadingUser} style={{ width: '45%' }}>
                                    <Form.Group className="mb-3 inputDetails" controlId="formBasicName">
                                        {/* <Form.Label class="mb-1 lableForm"> {i18.t('FirstName')}</Form.Label> */}
                                        <Form.Control className="rounded-custom  " type="text" id="FirstNameInput" />
                                    </Form.Group>

                                    <Form.Group className="mb-3 inputDetails" controlId="formAddress">
                                        {/* <Form.Label class="mb-1 lableForm"> {i18.t('address')}</Form.Label> */}
                                        <Form.Control className="rounded-custom  " type="text" id="AddressInput" />
                                    </Form.Group>

                                    <Form.Group className="mb-3 inputDetails" controlId="formBasicEmail">
                                        {/* <Form.Label class="mb-1 lableForm"> {i18.t('mailAdress')}</Form.Label> */}
                                        <Form.Control className="rounded-custom  " type="email" id="EmailInput" />
                                    </Form.Group>

                                    <Form.Group className="mb-3 inputDetails" controlId="formBasicPhone">
                                    ...
                                    <button className="align-items-center d-flex justify-content-center actionSection rounded-custom customShadow text-white bg-gold  border-0 goldButton" style={language == "he" ? { fontSize: '17px', width: '65%', marginRight: 'auto' } : { fontSize: '17px', width: '65%', marginLeft: 'auto' }}>
                                        {i18.t('update')}  {language == "he" ? <i class='fas fa-solid fa-arrow-left mr-3' style={{ fontSize: '17px' }}></i> : <i class='fas fa-solid fa-arrow-right ml-3' style={{ fontSize: '17px' }}></i>}
                                    </button>
                              ...
                              {userDetails.email == undefined &&
                                  ...
                                  <Form style={{ width: '45%' }}>
                                    <input type="text" class="icon-rtl"  placeholder="Search"/>
                                  ...
                                  <button className="align-items-center d-flex justify-content-center actionSection rounded-custom customShadow text-white bg-gold  border-0 goldButton" style={language == "he" ? { fontSize: '17px', width: '65%', marginRight: 'auto' } : { fontSize: '17px', width: '65%', marginLeft: 'auto' }}>
                                      {i18.t('save')}  {language == "he" ? <i class='fas fa-solid fa-arrow-left mr-3' style={{ fontSize: '17px' }}></i> : <i class='fas fa-solid fa-arrow-right ml-3' style={{ fontSize: '17px' }}></i>}
                                  </button>
                        ...
                        <div className=" bg-grey p-3 mb-5">
                            <label className="  w-100 pt-1 swithSide  goldbgColor  mb-0" > {i18.t('deliveryDetails')} </label>
                            <hr className="hrCheckout mt-0 mb-4" />
 ...
 */}
                            ...
                            <div className="mt-2"><label className="lableForm">{i18.t('shippingMethod')}</label>
                            ...
                            <Form.Select aria-label="Default select example" className="rounded-custom w-75" style={language == 'he' ? { padding: '0.375rem 0.75rem 0.375rem 2.25rem', backgroundPosition: 'left 0.75rem center' } : { backgroundPosition: 'right 0.75rem center' }} required>
                                <option></option>
                            ...
                            <Form.Label class="mb-2  lableForm"> {i18.t('Address')}</Form.Label>
                            <Form.Select aria-label="Default select example" className="rounded-custom w-75" style={language == 'he' ? { padding: '0.375rem 0.75rem 0.375rem 2.25rem', backgroundPosition: 'left 0.75rem center' } : { padding: '0.375rem 2.25rem 0.375rem 0.75rem', backgroundPosition: 'right 0.75rem center' }} required>
                        ...
                        <div className="bg-grey p-3 mb-3">
                            <label className="  w-100 pt-1  swithSide  goldbgColor mb-0">  {i18.t('CommentsToOrder')}  </label>
                            <hr className="hrCheckout mt-0 mb-4" />
                            <div className="row p-2" style={isTablet ? { width: '100%' } : { width: '100%' }}>
                                <div class="form-group pr-1">
                                    {/* <label for="exampleFormControlTextarea1 " className="lableForm">{i18.t('CommentsToOrder')} </label> */}
                                    <textarea class="w-100  fontNumber customTextarea" rows={1} maxlength="250" ng-trim="false" id="exampleFormControlTextarea1" ></textarea>
                                </div>
                            </div>
                        ...
                        <div className="">
                            ...
                            <div class="form-check d-flex align-items-center">
                                ...
                                <u class="form-check-label mr-4 " for="flexCheckDefault" style={{ fontSize: 'smaller' }}>
                    ...
                    <div className="col-md-4 col-sm-12">
                        <div className="fixedDiv ">
                            ...
                            <div className=" bg-grey p-3">
                                <label className="  w-100 pt-1  swithSide  goldbgColor  mb-0"> {i18.t('OrderSummary')}  </label>
                                <hr className="hrCheckout mt-0 mb-4" />
